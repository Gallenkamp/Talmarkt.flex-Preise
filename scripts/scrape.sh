...
# WSW Tal.Markt Flex – FINAL-Preise Scraper
# Speichert stündliche Strompreise in monatliche CSV-Dateien
# Struktur: data/YYYY/MM-Monatsname.csv
...
echo "Fertig: ${COUNT} neue Einträge, ${SKIPPED} Duplikate übersprungen."
